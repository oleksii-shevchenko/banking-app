        ...
        <div class="col-5">
            <form method="post" action="${pageContext.request.contextPath}/api/openAccount" >
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" step="0.01" name="intiDeposit" value="${param.initDeposit}" placeholder="<fmt:message key="content.request.process.init" />" required>
                </div>
                <div class="form-group">
