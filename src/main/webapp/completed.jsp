...
<div class="container">
    <div class="row justify-content-center">
        <p style="font-size: 64px"><fmt:message key="content.completed.text" /></p>
    </div>
    <div class="row justify-content-center">
        <a href="${pageContext.request.contextPath}/index.jsp" class="text-center" style="font-size: 48px"><fmt:message key="content.completed.home" /></a>
    </div>
</div>
