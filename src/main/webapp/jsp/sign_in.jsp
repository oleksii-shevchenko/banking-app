    ...
    <div class="row justify-content-center">
        <div class="col-4">
            <form class="form-signin" action="${pageContext.request.contextPath}/api/signIn" method="post">
                ...
                <input type="text" name="login" class="form-control" placeholder=<fmt:message key="content.sign.in.login"/> required autofocus>
                <input type="password" name="pass" class="form-control" placeholder=<fmt:message key="content.sign.in.password" /> required>
